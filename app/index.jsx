    ...
    <View style={styles.mainContainer}>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          style={{ width: wp(72), height: wp(30), resizeMode:"contain"}} />
        </Animated.View>
        ...
        >
          <View style={styles.featureItem}>
            <Text style={styles.featureTitle}>{t('📊 Connect Once, Grow Daily')}</Text>
            <Text style={styles.featureDescription}>{t('Monitor your finances as they happen')}</Text>
          </View>
          <View style={styles.featureItem}>
            <Text style={styles.featureTitle}>{t('🎯 Inspiring Goals')}</Text>
          ...
          <View style={styles.featureItem}>
            ...
            <Text style={styles.featureDescription}>{t('Visualize your dreams and track your progress')}</Text>
          </View>
        </Animated.View>
